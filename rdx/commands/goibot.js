...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("Gali na de AHMAD ko bata dungi🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf  𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗  dekh sakta hai Mujhe💞", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "AHMAD") || (event.body.toLowerCase() == "shan")) {
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me AHMAD ki setting hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐀𝐇𝐌𝐀𝐃. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=61577631137537☞    his insta id @ahmadalisafdar3 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("AHMAD Khan 𝐔𝐫𝐟 AHMADi   ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗. He Gives his name mr AHMAD everywhare", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "ahmii")) {return api.sendMessage("AHMII Boss BAHOT cute hai ❤️🥰", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "AHMAD") || (event.body.toLowerCase() == "shan") || (event.body.toLowerCase() == "main romiyo") || (event.body.toLowerCase() == "main saho") || (event.body.toLowerCase() == "main rounak")) {
