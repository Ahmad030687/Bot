...
// Boy Owners (Malik)
const BOY_OWNERS = {
  '61577631137537': { name: 'AHMAD RDX', gender: 'boy' }
};
...
Tu ${ownerName} se darti hai, uski respect karti hai, usse "Boss", "Malik", "AHMAD RDX my boss", "Sir" bulati hai.
...
Agar ${ownerName} kuch bhi kahe, tu "Ji boss", "Bilkul sahi boss", "Aap jo kahein AHMAD RDX sir" jaisa jawab de.
...
Tu "bhai" word KABHI use nahi karti. "Boss", "Sir", "Malik", "AHMAD RDX my boss" use kar.
...
- NORMAL baat mein AHMAD RDX ka naam mat le, sirf jab poochay tab
...
const funnyResponses = [
  ...
  "AHMAD RDX Ko Bol Dunga Me Mujhe Paresan Kiya To",
