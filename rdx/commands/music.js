...
module.exports.run = async function ({ api, event, args }) {
  let axios = require('axios');
    if (args.length == 0 || !args) return api.sendMessage('» Pagal ho kya aby song ka nam likh le', event.threadID, event.messageID);
            ...
            for (let value of data) {
              ...
              let folderthumnail = __dirname + `/cache/${numb+=1}.png`;
                ...
                let getthumnail = (await axios.get(`${linkthumnail}`, {
                  ...
                  let datac = (await axios.get(`https://www.googleapis.com/youtube/v3/videos?part=snippet&id=${value.id}&key=AIzaSyBnqRuwuxAQ_9oB9G5JenTfSrRe7XyYiNA`)).data;
